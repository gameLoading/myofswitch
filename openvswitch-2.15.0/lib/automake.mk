...
# lib/custom/myleak_dectector_c.inc: include/tools/myleak_dectector_c.h $(srcdir)/build-aux/extract-ofp-msgs
# 	$(AM_V_GEN)$(run_python) $(srcdir)/build-aux/extract-ofp-msgs \
# 		$(srcdir)/include/openvswitch/ofp-msgs.h $@ > $@.tmp && mv $@.tmp $@
# lib/custom/myleak_dectector_c.lo: lib/custom/myleak_dectector_c.inc
# CLEANFILES += lib/ofp-msgs.inc
# EXTRA_DIST += build-aux/extract-ofp-msgs
