 ...
 * of OpenFlow to another. */
    ...
    /* OFPT 1.3+ (38): uint8_t[8][]. */
    OFPRAW_OFPT13_WPARAMS_SET_CONFIG,
...
/* Standard statistics. */
    ...
    /* OFPST 1.3+ (21): uint8_t[8][]. */
    OFPRAW_OFPST13_WPARAMS_STATS_REQUEST,

    /* OFPST 1.3+ (21): uint8_t[8][]. */
    OFPRAW_OFPST13_WPARAMS_STATS_REPLY,
...
enum ofptype {
    ...
    OFPTYPE_WPARAMS_STATS_REQUEST,        /* OFPRAW_OFPST13_WPARAMS_STATS_REQUEST. */
    OFPTYPE_WPARAMS_STATS_REPLY,          /* OFPRAW_OFPST13_WPARAMS_STATS_REPLY. */
    OFPTYPE_WPARAMS_SET_CONFIG,          /* OFPRAW_OFPT13_WPARAMS_SET_CONFIG. */
};
